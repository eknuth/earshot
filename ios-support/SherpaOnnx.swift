// Vendored from k2-fsa/sherpa-onnx (Apache-2.0): swift-api-examples/SherpaOnnx.swift
// Glue over the sherpa-onnx C API (declared in the bundled c-api.h via the bridging header).
// Not shipped in an SPM product, so vendored here for the benchmark sample.

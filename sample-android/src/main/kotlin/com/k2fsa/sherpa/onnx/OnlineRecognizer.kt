// Vendored from k2-fsa/sherpa-onnx (Apache-2.0): sherpa-onnx/kotlin-api/OnlineRecognizer.kt
...
//
// The long getModelConfig()/getOnlineLMConfig()/getEndpointConfig() example tables from
// upstream are intentionally omitted; they are asset-path samples, not part of the JNI
// contract. The streaming Nemotron model is configured directly in the sample provider.
